...
#### [Lesson 1: Introduction to Replit and using the IDE](./01-introduction-to-the-repl-it-ide.md)
...
#### [Lesson 2: Working with files using Replit](./02-managing-files-using-repl-it.md)
...
#### [Lesson 3: Managing dependencies with Replit](./03-handling-dependencies-with-repl-it.md)
...
#### [Lesson 4: Data science: plotting and graphing](./04-data-science-and-visualisation-with-repl-it.md)
...
#### [Lesson 5: Pair programming and using multiplayer](./05-pair-programming-using-multiplayer-with-repl-it.md)
...
#### [Lesson 6: Running projects from GitHub](./06-github-and-run-button.md)
...
#### [Lesson 7: Building a game with PyGame](./07-building-a-game-with-pygame.md)
...
#### [Lesson 8: Can you keep a secret? What about from time travellers?](./08-storing-secrets-and-history.md)
...
#### [Lesson 9: Creating a name splitting application using test driven development](./09-test-driven-development.md)
...
#### [Lesson 10: Become an elite hacker with productivity hacks](./10-productivity-hacks.md)
...
#### [Lesson 11: Keeping your data in check with the Replit database](./11-using-the-replit-database.md)
...
#### [Lesson 12: Repl audio - control (or create) your music with code](./12-audio.md)
...
#### [Lesson 13: Steganography - hiding messages in images](./13-steganography.md)

Share secret messages with your friends by hiding them inside images with steganography, Python and Replit.

#### [Lesson 14: 2D platform game with PyGame and Replit](./14-2d-platform-game.md)
...
#### [Lesson 15: Building a Chat App with Node.js and Replit](./15-repl-chat.md)
...
#### [Lesson 16: Build a static site generator in Python](./16-static-site-generator.md)

Build your own static site generator to build a custom blog from scratch.

#### [Lesson 17: Build a predictive text engine](./17-predictive-text-engine.md)

Build an autocomplete bot that can generate its own sentences.

#### [Lesson 18: Telegram Notes Bot](./18-telegram-bot.md)

Take notes on Telegram and have a bot automatically publish them to a web application.

#### [Lesson 19: Build a Snake Game with PyGame](./19-build-snake-with-pygame.md)

Revisit PyGame again to build the classic Snake game.

#### [Lesson 20: Build Your Online Store's Checkout Process with Stripe](./20-online-store-checkout-process.md)

Build an online store and integrate Stripe's checkout process.

#### [Lesson 21: Build a Snake Game with Kaboom.js](./21-build-snake-with-kaboom.md)

Build the classic Snake game while learning all about Kaboom.js game development.

#### [Lesson 22: Build a Personal Stock Market dashboard](./22-personal-stock-market-dashboard.md)

Build a single-page web dashboard for tracking your stock portfolio.

#### [Lesson 23: Building Asteroids Game with Kaboom.js](./23-build-asteroids-with-kaboom.md)

Revisit Kaboom.js again to build the classic Asteroids game.

#### [Lesson 24: Build a Space Shooter Game with Kaboom.js](./24-build-space-shooter-with-kaboom.md)

Continue to learn about Kaboom.js by building a Space Shooter game with a platformer feel.

#### [Lesson 25: Building a pseudo-3D game with Kaboom.js](./25-build-3d-game-with-kaboom.md)

Learn how to leverage early game design techniques to build a pseudo-3D game in a 2D game engine like Kaboom.js.

#### [Lesson 26: Generate PDF reports from spreadsheet data](./26-pdf-report-generator-from-spreadsheet.md)

Build a web application that takes in data from spreadsheets and use it to create slick PDF reports.

#### [Lesson 27: Building tic-tac-toe with WebSocket and Kaboom.js](./27-build-tictactoe-with-websockets-kaboom.md)
...
#### [Lesson 28: Build a team technical challenge website with `replit.web`](./28-technical-challenge-site.md)
...
#### [Lesson 29: Build a paid content site with `replit.web` and Stripe](./29-paid-content-site.md)

Revisit the `replit.web` framework and combine it with Stripe to build a digital content storefront.

#### [Lesson 30: Building with Nix on Replit](./30-build-with-nix.md)
...
#### [Lesson 31: Build an email news digest app with Nix, Python and Celery](./31-build-news-digest-app-with-nix.md)
...
#### [Lesson 32: Building a *Mario*-like side-scroller with Kaboom.js](./32-build-mario-with-kaboom.md)

Learn more on the capabilities of the Kaboom game engine by building a *Mario*-like side-scroller game.

#### [Lesson 33: Build an escrow contract on the Ethereum blockchain with Solidity and Replit](./33-escrow-contract-with-solidity.md)
...
#### [Lesson 35: Build Flappy Bird with Kaboom](./35-build-flappy-bird-with-kaboom.md)

Revisit the Kaboom game engine on Replit by building a Flappy Bird game.

#### [Lesson 36: Build a physics playground with Kaboom](./36-physics-playground-with-kaboom.md)

Explore the advanced usage of the Kaboom game development framework by building a 2D Physics engine.

#### [Lesson 37: Build a block-breaking game with Kaboom](./37-build-breakout-with-kaboom.md)
...
#### [Lesson 38: Rendering 3D scenes with three.js](./38-3D-rendering-with-threejs.md)
